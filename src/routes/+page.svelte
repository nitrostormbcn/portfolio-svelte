...
<div class="content text-container my-auto cursor-grab lg:cursor-auto touch-none">
	...
	<p class="text-xl lg:text-3xl">
		You'll find some cool code projects, some art I made, and maybe some hidden cats<DropCat
		></DropCat>
	</p>
</div>
