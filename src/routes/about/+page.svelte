...
<div class="text-container mt-10 flex flex-col items-stretch">
	...
	<p class="my-1 text-justify text-xl lg:text-3xl">I'm Pau, QA Engineer @ Sanoma</p>
	<p class="my-1 text-justify text-xl lg:text-3xl">Industrial Engineer turned Software Developer</p>
	<p class="self-center">
